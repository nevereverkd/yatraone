...
export const TripHero: React.FC<TripHeroProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* ---------------------------------------------------------------- */}
      <div className="p-4 sm:p-6 bg-[#FFFFFF] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-t border-[#E8E2D9]">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {onOpenScanner && (
            <button
              ...
              onClick={onOpenScanner}
              className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-[#191715] hover:bg-[#C84B31] text-white text-xs font-bold transition-all shadow-xs cursor-pointer whitespace-nowrap"
            >
          ...
          <button
            ...
            onClick={onOpenMap}
            className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-[#FAF8F5] hover:bg-[#F3EFEA] text-[#191715] border border-[#E8E2D9] text-xs font-bold transition-all cursor-pointer whitespace-nowrap"
          >
          ...
          <button
            ...
            onClick={onAddActivity}
            className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-[#C84B31] hover:bg-[#B83E26] text-white text-xs font-bold transition-all shadow-xs cursor-pointer whitespace-nowrap"
          >
