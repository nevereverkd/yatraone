      ...
      >
        ...
        <div className="flex-1 flex flex-col md:flex-row relative overflow-hidden">
          ...
          <div className="flex-1 h-full relative bg-[#EAE6DF] overflow-hidden">
            ...
            <div className="absolute bottom-3 left-3 z-10 hidden sm:flex items-center bg-white/90 backdrop-blur-md p-1 rounded-xl border border-[#E5E0D8] shadow-sm text-xs">
              ...
              <button
                ...
                className={`px-2 py-0.5 rounded-lg font-semibold transition-colors ${
                  mapStyle === 'voyager' ? 'bg-[#191715] text-white' : 'text-[#66605B]'
                }`}
              >
                Pastel
              </button>
              <button
                ...
                className={`px-2 py-0.5 rounded-lg font-semibold transition-colors ${
                  mapStyle === 'osm' ? 'bg-[#191715] text-white' : 'text-[#66605B]'
                }`}
              >
                Standard
              </button>
              <button
                ...
                className={`px-2 py-0.5 rounded-lg font-semibold transition-colors ${
                  mapStyle === 'satellite' ? 'bg-[#191715] text-white' : 'text-[#66605B]'
                }`}
              >
                Satellite
              </button>
