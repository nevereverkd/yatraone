            ...
            {onSelectTab && (
              <>
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold flex items-center gap-1.5 transition-all cursor-pointer bg-white text-[#5A524C] hover:bg-[#F8F6F2] hover:text-[#0F766E] border border-[#EAE5DC]"
                  title="Browse ASI-certified tourist guides"
                >
                ...
                <button
                  id="subtab-crafts-btn"
                  onClick={() => onSelectTab('crafts')}
                  className="px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold flex items-center gap-1.5 transition-all cursor-pointer bg-white text-[#5A524C] hover:bg-[#F8F6F2] hover:text-amber-800 border border-[#EAE5DC]"
                  title="Explore authentic GI artisan craft guilds"
                >
                  <ShoppingBag className="w-4 h-4 text-amber-700" />
                  <span>GI Crafts Guilds</span>
                ...
                <button
                  id="subtab-transit-rates-btn"
                  onClick={() => onSelectTab('transit')}
                  className="px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold flex items-center gap-1.5 transition-all cursor-pointer bg-white text-[#5A524C] hover:bg-[#F8F6F2] hover:text-[#0284C7] border border-[#EAE5DC]"
                  title="Check official pre-paid auto rate cards"
                >
                  <Ticket className="w-4 h-4 text-[#0284C7]" />
                  <span>Auto Rate Cards</span>
                </button>
              </>
            )}
          </div>
